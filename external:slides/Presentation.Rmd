...
knitr::include_graphics("figures/veh_dense.png")
```
...
quite worked with Worcester. So this map displays subsidy above and below the system average of 3 dollars, and had a high category for outliers above ten dollars. Folks who take the Park Avenue Connector may be paying a buck seventy five, but it costs a whopping 28 dollars per person!
...
knitr::include_graphics("figures/subs_cat.png")
...
```{r, fig.align ='center', out.width = "70%", echo = FALSE, eval = FALSE}
